...
window.ALGOREQUIEM_MOVEMENTS.push({
  ...
  slug:     'sileicon',
  status:   'sealed',
  type:     'custom',    // flagged in prior discussion as structurally different from Androït — confirm once designed
  heading:  { prefix: 'II_', title: 'Sileicon' },
  nextLabel: 'III_of-vectors'      // shown once this movement's last page is reached
});
